...
export class BoardArticleService {
    ...
    private  boardArticleModel:Model<BoardArticle>,
    ...
    public async getBoardArticle(memberId: ObjectId, articleId: ObjectId):Promise<BoardArticle>{
        ...
        if(memberId){
            ...
            if(newView){ 
                await this.boardArticleStatsEditior({_id: articleId, targetKey:'articleViews',modifier:1});
                targetBoardArticle.articleViews++;
            }
            //meLiked
            const likeInput = {memberId: memberId, likeRefId: articleId, likeGroup: LikeGroup.ARTICLE};
            targetBoardArticle.meLiked = await this.likeService.cheekLikeExistence(likeInput);
    ...
    public async boardArticleStatsEditior(input:StatisticModifier):Promise<BoardArticle>{
